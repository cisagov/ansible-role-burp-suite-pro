...
[![License](https://img.shields.io/github/license/cisagov/ansible-role-burp-suite-pro)](https://spdx.org/licenses/)
...
secrets on the
[appropriate page](https://github.com/cisagov/ansible-role-burp-suite-pro/settings/secrets)
...
| burp\_suite\_pro\_third\_party\_bucket\_name | The name of the AWS S3 bucket where third-party software is located. | n/a | Yes |
